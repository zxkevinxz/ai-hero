Code execution is an alternative model to orchestrators. By getting the LN to write and execute code, you can essentially ask the element to call tools via the code it creates.
